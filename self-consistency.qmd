...
An important distinction in this literature: **self-consistency as a failure mode** versus **self-consistency as a decoding strategy**. The [Wang et al. self-consistency method](https://arxiv.org/abs/2203.11171) (majority vote over chains) improves outcomes, but it does not imply that the base model is internally coherent. A more cautious interpretation is that performance gains come from sampling diverse reasoning paths and selecting the most common one.
